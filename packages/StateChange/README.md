# StateChange &middot; [![Build Status](https://travis-ci.com/plotmap-org/plotmap-web.svg?branch=packages/StateChange)](https://travis-ci.com/plotmap-org/plotmap-web)
...
```js
import { EventMap, event } from "@plotmap/eventmap";
...
```js
import {applyStateChangeRdtLogging} from "@plotmap/StateChange/applyStateChangeRdtLogging";
...
```js
import {applyImmerToStateChange} from "@plotmap/StateChange/applyImmerToStateChange";
...
```js
import {applyStateChangeConsoleLogging} from "@plotmap/StateChange/applyStateChangeConsoleLogging";
...
```js
import {applyStateChangeErrorHandling} from "@plotmap/StateChange/applyStateChangeErrorHandling";
applyStateChangeErrorHandling();
```

### Adding custom middleware
```js
import {StateChange} from "@plotmap/StateChange";
