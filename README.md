...
| [StateController](https://github.com/domxjs/domx/tree/master/packages/StateController) | [![Build Status](https://travis-ci.com/domxjs/domx.svg?branch=master)](https://travis-ci.com/github/domxjs/domx) | [![npm](https://img.shields.io/npm/v/@domx/statecontroller)](https://www.npmjs.com/package/@domx/statecontroller) | A StateController base class for handling data state changes on a LitElement
